...
# CORS Settings — read from env, with localhost fallbacks for dev
...
_csrf_env = os.getenv('CSRF_TRUSTED_ORIGINS', 'http://localhost:3000,http://127.0.0.1:3000')
...
MEDIA_ROOT = BASE_DIR / 'chat_files'
